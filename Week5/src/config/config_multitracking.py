...
class ConfigMultiTracking:
    ...
    def get_args():
        ...
        # =================== AIC2018 ====================
        parser.add_argument('--tracking_csv', default= '../../raw_data/train', type=str, help='tracking result csv file')
        parser.add_argument('--output', default='../outputs/multitracking', help='output dir for track obj pickle & track csv')
