...
class Track(object):
    ...
    def halfway_appear(self, roi):
        ...
        if bx[0]>side_th and bx[1]>side_th and bx[0]+bx[2]<w-side_th and bx[1]+bx[3]<h-side_th and roi[int(c_y)][int(c_x)][0]>128:
            return True
        else:
            return False
...
def main():
    ...
    time_stamp_file = '../aic19-track1-mtmc/cam_timestamp/test.txt'
    time_stamp_dict = analysis_time_stamp(time_stamp_file)
    # fps_file = "../aic19-track1-mtmc/cam_timestamp/eval_fps.txt"
    fps_file = "../aic19-track1-mtmc/cam_timestamp/test_fps.txt"
